...
class SmackCSVInstall {
	...
	public function smack_uci_action_links( $links ) {
		$links[] = '<a href="'. esc_url( get_admin_url(null, 'admin.php?page=cf-uci-settings') ) .'">Settings</a>';
	...
	public static function plugin_row_meta( $links, $file ) {
			$row_meta = array(
				...
				'videos'   => '<a href="' . esc_url( apply_filters( 'sm_uci_videos_url', 'https://www.youtube.com/watch?v=48soc8Wu4zs&feature=youtu.be' ) ) . '" title="' . esc_attr( __( 'View Videos for WP Importer Custom fields PRO', 'wp-importer-customfields-pro' ) ) . '" target="_blank">' . __( 'Videos', 'wp-importer-customfields-pro' ) . '</a>',
	...
	public static function important_cron_notice() {
		...
		if($get_notice != 'off' && isset($_REQUEST['page']) && $_REQUEST['page'] == 'cf-uci-import') {
			?>
			...
			<?php
			if(function_exists( 'curl_version' ) == null || function_exists( 'curl_version' ) == '' && isset($_REQUEST['page']) && $_REQUEST['page'] == 'cf-uci-import') { ?>
