...
class JetEngineExtension extends ExtensionHandler{
	...
	*/
	...
	function import_post_types($import_type, $importAs = null) {	
		...
		$module = array('Posts' => 'post', 'Pages' => 'page', 'Users' => 'user', 'WooCommerce Product Variations' => 'product_variation', 'WooCommerce Refunds'=> 'shop_order_refund', 'WooCommerce Orders' => 'shop_order','WooCommerce Coupons' => 'shop_coupon', 'Comments' => 'comments', 'Taxonomies' => $importAs, 'WooCommerce Product' => 'product', 'CustomPosts' => $importAs);
