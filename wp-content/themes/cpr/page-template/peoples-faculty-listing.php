  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
		...
		<div class="container"> 
<div class="hide-data" id="datafetch_pf">	
...
jQuery('.search-button').css({"cursor": "pointer", "pointer-events": "auto"});
	if(keyword != ""){
			jQuery.ajax({
				...
				type: 'post',
				data: { action: 'data_fetch_pf_name', keyword: jQuery('#keyword').val() },
				success: function(data) {
					jQuery('#datafetch_pf').html( data );
				}
			}); 
	}
  }
...
jQuery('.search-button').css({"cursor": "pointer", "pointer-events": "auto"});
	  if(designation != ""){
			jQuery.ajax({
				url: '<?php echo admin_url('admin-ajax.php'); ?>',
				type: 'post',
				data: { action: 'data_fetch_pf', designation: jQuery('#designation').val() },
				success: function(data) {
					jQuery('#datafetch_pf').html( data );
				}
			});
