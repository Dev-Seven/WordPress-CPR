...
/*
 * Template Name:  People Finance Admin
...
<div class="container"> 
<div class="hide-data" id="data_fetch_pfinance">
	<?php
...
if(keyword != "")
		{
			...
			jQuery.ajax({
				...
				type: 'post',
				data: { action: 'data_fetch_pfinance', keyword: jQuery('#keyword').val() },
				success: function(data) {
					jQuery('#data_fetch_pfinance').html( data );
				}
			});
		}
...
jQuery('.search-button').css({"cursor": "pointer", "pointer-events": "auto"});
	  if(designation != ""){
			jQuery.ajax({
				url: '<?php echo admin_url('admin-ajax.php'); ?>',
				type: 'post',
				data: { action: 'data_fetch_pfinance_name', designation: jQuery('#designation').val() },
				success: function(data) {
					jQuery('#data_fetch_pfinance').html( data );
				}
			});
