		...
		<div class="opening-listing">
	        <div class="container">
				...
				<div class="col-md-12">
                    ...
                    <input class="form-control" type="text" placeholder="Search Job Title or Keyword" aria-label="search">
							</div>
					...
					<button class="search-button" type="button">Search<span>&gt;</span></button>	
