...
/*
 * Template Name:  People Research Staff
		  ...
		  <div class="col-md-12">
			  <div class="faculty-searchbar">
				...
				<form class="form" id="superform" action="" method="post" enctype="">
					...
					<label>Search People</label><input class="form-control" type="text" id="keyword" placeholder="Search Name" aria-label="search"><input class="form-control" type="text" id="designation"  placeholder="Search by Designation" aria-label="search"><button class="search-button" type="button" onClick="fetch()">Search<span>&gt;</span></button>
				  </form>
...
<div class="container"> 
<div class="hide-data" id="data_fetch_presearch_staff">
...
if(keyword != "")
		{
			...
			jQuery.ajax({
				...
				type: 'post',
				data: { action: 'data_fetch_presearch_staff', keyword: jQuery('#keyword').val() },
				success: function(data) {
					jQuery('#data_fetch_presearch_staff').html( data );
				}
			});
		}
...
jQuery('.search-button').css({"cursor": "pointer", "pointer-events": "auto"});
	  if(designation != ""){
			jQuery.ajax({
				url: '<?php echo admin_url('admin-ajax.php'); ?>',
				type: 'post',
				data: { action: 'data_fetch_presearch_staff_name', designation: jQuery('#designation').val() },
				success: function(data) {
					jQuery('#data_fetch_presearch_staff').html( data );
				}
			});
...
<?php
function ajax_fetch_presearch_staff() {
  ?>
