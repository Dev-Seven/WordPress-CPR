...
/*
 * Template Name:  People Staff Directory
...
<div class="container"> 
<div class="hide-data" id="datafetch_staffdirectory">
...
if(keyword != "")
		{
			...
			jQuery.ajax({
				...
				type: 'post',
				data: { action: 'data_fetch_staffdirectory', keyword: jQuery('#keyword').val() },
				success: function(data) {
					jQuery('#datafetch_staffdirectory').html( data );
				}
			});
		}
...
jQuery('.search-button').css({"cursor": "pointer", "pointer-events": "auto"});
	  if(designation != ""){
			jQuery.ajax({
				url: '<?php echo admin_url('admin-ajax.php'); ?>',
				type: 'post',
				data: { action: 'data_fetch_staffdirectory_name', designation: jQuery('#designation').val() },
				success: function(data) {
					jQuery('#datafetch_staffdirectory').html( data );
				}
			});
...
<?php
function ajax_fetch_staffdirectory() {
  ?>
