...
/*
 * Template Name:  People Communications
...
<div class="faculty-listing">
  <div class="container">
	...
	<div class="container"> 
<div class="hide-data" id="datafetch_communications">
...
if(keyword != "")
		{
			...
			jQuery.ajax({
				...
				type: 'post',
				data: { action: 'data_fetch_communications', keyword: jQuery('#keyword').val() },
				success: function(data) {
					jQuery('#datafetch_communications').html( data );
				}
			});
		}
...
jQuery('.search-button').css({"cursor": "pointer", "pointer-events": "auto"});
	  if(designation != ""){
			jQuery.ajax({
				url: '<?php echo admin_url('admin-ajax.php'); ?>',
				type: 'post',
				data: { action: 'data_fetch_communications_name', designation: jQuery('#designation').val() },
				success: function(data) {
					jQuery('#datafetch_communications').html( data );
				}
			});
...
<?php
function ajax_fetch_communications() {
  ?>
