<?php
/**
 * Template Name: Journal Article Template
 *
...
<div class="ja-listing ja-list">
  <div class="container">
	  <div class="row common">
          ...
          <div class="search-box">
            ...
            <div class="project-search-bar">
              <input class="form-control" type="text" id="keyword" placeholder="Search Journal Articles" aria-label="search">
            </div>
     ...
     <div class="hide-data" id="datafetch_ja">	
              ...
              <div class="ja-date"> 
                <a href="<?php  echo get_permalink( $id ) ?>">
                    <div class="publisher-name"> 
                          <?php echo mb_strimwidth($publisher_name, 0, 30, "..."); ?>
                            <br><?php echo $published_date; ?> 
                    </div>
                </a>
               </div>
            </div>
	...
	if(keyword != "")
		{
			...
			jQuery.ajax({
				...
				type: 'post',
				data: { action: 'data_fetch_ja', keyword: jQuery('#keyword').val() },
				success: function(data) {
					jQuery('#datafetch_ja').html( data );
				}
			});
		}
}
