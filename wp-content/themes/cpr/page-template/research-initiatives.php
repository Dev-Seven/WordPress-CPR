   ...
   $research_image = get_field( 'research_image' );
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-5 col-lg-4 col-xl-3 col-xxl-3">   <a href="<?php  echo get_permalink( $id ) ?>" >
              <?php if ($research_image != "") { ?>
                <img src="<?php echo $research_image; ?>" alt=""></a> 
               <?php } else { ?>
          ...
          <a href="<?php  echo get_permalink( $id ) ?>"> <h3>
            ...
            <p>
              ...
              echo mb_strimwidth($content, 0, 465, "...");?>
            </p>
	  ...
	  <div class="rin-listing-item <?php echo $even_odd_class; ?>">
        ...
        <?php if ($research_image != "") { ?>
             <img src="<?php echo $research_image; ?>" alt=""> 
             <?php } else { ?>
                    <img src="<?php echo site_url(); ?>/wp-content/uploads/2021/12/no-image.png" />
              <?php } ?>
          </a>
       ...
       echo mb_strimwidth($content, 0, 465, "...");?></p>
