...
jQuery(document).ready(function() {
    ...
    // console.log($(".tab-content").scrollTop() + $(".tab-content").height());
    // console.log($(".tab-content").scrollTop());
    // if ($(".tab-content").scrollTop() + $(".tab-content").height() >= $(".tab-content").height() - 100) {
    //     // load_posts();   
    //     console.log('LOAD')
    // }
    // });
