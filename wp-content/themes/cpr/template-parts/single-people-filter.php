...
<?php function data_fetch_singlepeople7(){ ?>
...
<?php /*?>      <?php if ( $allCategories->have_posts() ) : ?>
      ...
      <?php while ( $allCategories->have_posts() ): $allCategories->the_post(); ?>
	 <?php  $author_name = get_field( 'wp_author_name' );
...
<?php function data_fetch_singlepeople6(){ 
?>
...
<?php function data_fetch_singlepeople2(){ 
?>
...
<?php function data_fetch_singlepeople3(){ 
?>
...
<?php function data_fetch_singlepeople4(){ 
?>
...
<?php function data_fetch_singlepeople5(){ 
?>
...
<?php function data_fetch_singlepeople8(){ 
?>
...
<?php function data_fetch_singlepeople9(){ 
?>
