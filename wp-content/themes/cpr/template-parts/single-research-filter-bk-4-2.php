...
<?php function data_fetch_singleresearch7(){ ?>
...
<?php function data_fetch_singleresearch6(){ 
?>
...
<?php function data_fetch_singleresearch2(){ 
?>
<div id="tab2" class="tab_content" style="display:block;">
	...
	<?php 
	 ...
	 <div class="tab-news-sec">
          ...
          <div class="news-date">
            <p>
            <?php echo the_field("opinion_published_date", $document->ID ); ?>
            </p>
            <p><a href="<?php echo get_permalink($document->ID ); ?>"><?php echo the_field("author_name", $document->ID ); 
     ...
     <?php /*?> <a href="<?php echo the_field("opinion_link", $document->ID ); ?>" target="_blank">					
          <div class="tab-news-sec">
              <div class="tab-news-text">
...
<?php function data_fetch_singleresearch3(){ 
?>
...
<?php function data_fetch_singleresearch4(){ 
?>
<div id="tab4" class="tab_content" style="display:block;">
      ...
      <?php $bookstitle = get_the_title( $document->ID );?>
        <div class="tab-news-sec">
          ...
          <div class="news-date">
            <p><?php echo the_field("published_date", $document->ID ); ?></p>
            <p><a href="<?php echo get_permalink( $document->ID ); ?>"><?php echo the_field("author_name", $document->ID ); ?></a></p>
          </div>
        </div>
...
<?php function data_fetch_singleresearch5(){ 
?>
...
<?php function data_fetch_singleresearch8(){ 
?>
        ...
        <div class="tab-news-sec">
          <div class="tab-news-text">
           <h3><?php echo mb_strimwidth($newstitle, 0, 60, "...");?><?php //echo get_the_title( $document->ID ); ?> </h3>
            <?php /*?><p><?php echo the_field("publisher_name", $document->ID ); ?></p><?php */?>
          </div>
          <div class="news-date">
...
<?php function data_fetch_singleresearch9(){ 
?>
